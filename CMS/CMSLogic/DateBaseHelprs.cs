    ...
    public class DateBaseHelprs
    {
        public DataTable GetItemsByparameter(string topnumber,string Params)
        {
            ...
            try
            {
                ...
                string sql = string.Format("SELECT     TOP ({0})   ItemTopic,  PhotoName,  SummaryTxt, ItemID,  ShowDate ,PartID , DATEDIFF(day, GETDATE(), EventDate) as dayE, DATEDIFF(day, DATEPART(HOUR, GETDATE()), DATEPART(HOUR, EventDate)) as HourE , " +
